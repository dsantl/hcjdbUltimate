...
public class MessageOutput {
	...
	static void printDirectln(String line) {
		ConsoleInputOutputModule.println(line);
	}

	static void printDirect(String line) {
		ConsoleInputOutputModule.print(line);
	}

	static void printDirect(char c) {
		ConsoleInputOutputModule.print(c);
	}
	 ...
	 */
	static void println() {
		ConsoleInputOutputModule.println();
	}
	...
	static void print(String key) {
		ConsoleInputOutputModule.print(format(key));
	}
	...
	static void println(String key) {
		ConsoleInputOutputModule.println(format(key));
	}
	...
	static void print(String key, String argument) {
		ConsoleInputOutputModule.print(format(key, argument));
	}

	static void println(String key, String argument) {
		ConsoleInputOutputModule.println(format(key, argument));
	}
	...
	static void println(String key, Object[] arguments) {
		ConsoleInputOutputModule.println(format(key, arguments));
	}
	...
	static void lnprint(String key) {
		ConsoleInputOutputModule.println();
		ConsoleInputOutputModule.print(textResources.getString(key));
	}
	...
	static void lnprint(String key, Object[] arguments) {
		ConsoleInputOutputModule.println();
		ConsoleInputOutputModule.print(format(key, arguments));
	}
	...
	static void printException(String key, Exception e) {
		...
		ConsoleInputOutputModule.flush();
		e.printStackTrace();
	}
	...
	static void printPrompt() {
		...
		if (threadInfo == null) {
			ConsoleInputOutputModule.printPrompt(MessageOutput.format("jdb prompt with no current thread"));
		} else {
			ConsoleInputOutputModule.printPrompt(MessageOutput.format("jdb prompt thread name and current stack frame",
					new Object[] { threadInfo.getThread().name(), new Integer(threadInfo.getCurrentFrameIndex() + 1) }));
		}
		ConsoleInputOutputModule.flush();
	}
}
